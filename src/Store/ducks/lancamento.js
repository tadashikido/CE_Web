export const Types = {
  ...
  LOAD_AUTOLANCAMENTO: "newLancamento/LOAD_AUTOLANCAMENTO",
  LOAD_CARTEIRAS: "newLancamento/LOAD_CARTEIRAS",
  LOAD_CARTEIRAS_DESTINOS: "newLancamento/LOAD_CARTEIRAS_DESTINOS",
  LOAD_FORNECEDORES: "newLancamento/LOAD_FORNECEDORES",
  LOAD_CLIENTES: "newLancamento/LOAD_CLIENTES",
  LOAD_SERVICOS: "newLancamento/LOAD_SERVICOS",
  LOAD_CONTAS_CONTABEIS: "newLancamento/LOAD_CONTAS_CONTABEIS",
  ...
  AUTOLAN_CHANGE: "newLancamento/AUTOLAN_CHANGE",
  CONTA_CONTABIL_CHANGE: "newLancamento/CONTA_CONTABIL_CHANGE",
  FORNECEDOR_CHANGE: "newLancamento/FORNECEDOR_CHANGE",
  CLIENTE_CHANGE: "newLancamento/CLIENTE_CHANGE",
  CARTEIRA_DESTINO_CHANGE: "newLancamento/CARTEIRA_DESTINO_CHANGE",
  SERVICO_CHANGE: "newLancamento/SERVICO_CHANGE",

  TOGGLE_VALOR_EDITING: "newLancamento/TOGGLE_VALOR_EDITING",

  PROCESSING: "newLancamento/PROCESSING",
  PROCESSED: "newLancamento/PROCESSED",
  PROCESS_ERRO: "newLancamento/PROCESS_ERRO",
  SUCCESS_SAVE: "newLancamento/SUCCESS_SAVE",
  ERROR_SAVE: "newLancamento/ERROR_SAVE",
  REMOVE_SUCCESS: "newLancamento/REMOVE_SUCCESS"
};
